#!/usr/bin/env python3
"""
Simple Raspberry Pi 5 Deployment Script

Creates a deployment package optimized for Raspberry Pi 5 (8GB).
"""
...
# Optional notifications (Pi 5 can handle these)
twilio>=8.5.0
...
def main():
    ...
    print("\nTo deploy to Raspberry Pi 5:")
    print("1. Copy the deployment folder to your Pi 5")
